...
module.exports = function($, _) {
  ...
  function submitWebflow(data) {
    ...
    if (retro && url.indexOf(FORM_SUBMIT_HOST) >= 0) {
      url ="NOTHING HERE" // url.replace(FORM_SUBMIT_HOST, FORM_OLDIE_HOST);
    }
...
Webflow.require('ix').init([
  ...
  {"slug":"navi-appearance","name":"Navi Appearance","value":{"style":{},"triggers":[{"type":"scroll","selector":".navbar","offsetBot":"60%","stepsA":[{"transition":"transform 400ms ease-in 0ms","x":"0px","y":"0px"},{"display":"block","opacity":1,"transition":"opacity 400ms ease-in 0ms"}],"stepsB":[]}]}},
  {"slug":"display-none-navi","name":"Display None Navi","value":{"style":{"opacity":0,"x":"0px","y":"-100px"},"triggers":[]}}
]);
